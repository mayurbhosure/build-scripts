...
# Version       : geronimo-json_1.1_spec-1.2
# Source repo   : https://github.com/apache/geronimo-specs
# Tested on     : UBI 9.3
# Language      : Java
# Travis-Check  : True
...
# ----------------------------------------------------------------------------
set -e
PACKAGE_NAME=geronimo-specs
PACKAGE_URL=https://github.com/apache/geronimo-specs.git
PACKAGE_VERSION=${1:-geronimo-json_1.1_spec-1.2}
